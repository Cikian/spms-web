        ...
        >
          <template #reference>
            <el-form-item label="日费用（元）">
              <el-input @keydown.enter="queryResourceCostListByCondition" type="number"
                        v-model="queryResourceCostConditionForm.dailyCost" placeholder="请输入目标费用" clearable/>
            </el-form-item>
          </template>
        </el-popover>
        <!--        <el-popover-->
